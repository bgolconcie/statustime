...
DO $$ BEGIN
  ...
  ALTER TABLE tracked_users ADD COLUMN IF NOT EXISTS tracking_enabled BOOLEAN DEFAULT true;
  ALTER TABLE organizations ADD COLUMN IF NOT EXISTS plan_seats INT DEFAULT 1;
