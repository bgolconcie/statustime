...
export function UserDetail() {
  ...
  return (
    <div>
      ...
      {/* Billing */}
      {user && <BillingPanel key={user.id} userId={user.id} costType={user.cost_type} costAmount={user.cost_amount} priceType={user.price_type} priceAmount={user.price_amount} currency={user.currency} projectName={user.project_name} />}
